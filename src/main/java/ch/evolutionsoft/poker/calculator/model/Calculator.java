...
import ch.evolutionsoft.poker.calculator.model.PlayerHand;
...
public class Calculator implements Serializable {
	...
	static {
		gameTypes.put(Integer.toString(Enumerate.GAME_OMAHA),
		    new SelectItem(new Integer(Enumerate.GAME_OMAHA), "Omaha High"));
		gameTypes.put(Integer.toString(Enumerate.GAME_OMAHA8),
		    new SelectItem(new Integer(Enumerate.GAME_OMAHA8), "Omaha Hi/Lo"));
		gameTypes.put(Integer.toString(Enumerate.GAME_HOLDEM),
		    new SelectItem(new Integer(Enumerate.GAME_HOLDEM), "Texas Hold'em"));
	}
